...
export const series: SeriesRecord[] = [
  ...
  { slug: "chigo-lotos-on-off-169", brand: "Chigo", name: "Lotos on-off 169", technology: "on-off", models: ["CS-21H3A-B169", "CS-25H3A-B169", "CS-35H3A-1C169", "ветка 51", "CT3S-100H3A-1E169"], note: "Точную модификацию и комплектацию уточните у менеджера." },
  { slug: "chigo-moon-on-off-181", brand: "Chigo", name: "Moon on-off 181", technology: "on-off", models: ["CS-21H3A-B181", "CS-25H3A-B181", "CS-35H3A-1C181", "CS-51H3A-1B181", "CS-61H3A-1D181", "CS-88H3A-1H181", "CT3S-100H3A-1E181"], note: "Точную модификацию для индексов 61, 88 и 100 уточните у менеджера." },
...
export const faqs = [
  ...
  { q: "Почему на сайте нет цен «от»?", a: "Цена зависит от точной модели, комплектации, наличия и условий монтажа. Позвоните менеджеру: он проверит актуальную стоимость и поможет подобрать подходящий вариант." },
  { q: "Как уточнить характеристики и наличие?", a: "Откройте страницу нужной серии и позвоните менеджеру по указанному номеру. Он уточнит исполнение, наличие, комплектацию и параметры конкретной модели." },
];
