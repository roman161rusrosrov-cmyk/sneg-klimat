...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const core = ["", "catalog", "ventilation", "brands", "solutions", "vrf", "services", "guides", "calculator", "tools", "selection", "brief", "favorites", "favorites-compare", "compare", "placement", "maintenance", "troubleshooting", "project-stages", "checklists", "myths", "glossary", "faq", "site-info"];
  ...
  return [
    ...
    ...ventilationSystems.map((item) => ({ url: url(`ventilation/${item.slug}`), changeFrequency: "monthly" as const, priority: 0.75 })),
